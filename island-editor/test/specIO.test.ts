...
describe('specIO', () => {
  it('round-trips a v4 spec through serialize/deserialize', () => {
  ...
  it('migrates a v3 spec to v4 with an empty objects array', () => {
    // Build a valid v3 file: serialize a v4 seed, then downgrade to version 3
  ...
  it('throws on an unsupported version', () => {
    expect(() => validateSpecObject({ ...v2Spec(), version: 5 })).toThrow(/version must be/)
  })
