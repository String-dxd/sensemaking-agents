...
export const DEFAULT_MY_WORLD_FAQ_WHY_STORY = {
  ...
  introduction:
    'My World tests whether quick captures help students notice patterns and talk about them with people they trust. That outcome is still unproven.',
  ...
  researchBody:
    'Brief, in-the-moment reports may reduce memory gaps and show changes across days. This supports testing a lighter Capture rhythm.',
  hypothesisBody:
    'A joyful Capture may help students share honest moments instead of polished survey answers. A pilot must compare its value and burden with simpler options.',
