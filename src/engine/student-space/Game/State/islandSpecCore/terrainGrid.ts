 ...
 *  the raw field keeps the interpolating `smoothBilinear`, which preserves
 *  the flat-top/cell-center anchoring. The feature-preservation floors on
 *  `sampleTierField` (BLUR_MIX comment) were re-verified and re-pinned for
 *  this kernel in the suites listed there. */
